 ...
 What is a Void Element? Give Examples  Answer: The elements that do not have a closing tag. eg:<br>,<hr>.
 ...
 What are meta tag and why is it used  Answer: Meta tags are tags that give information about the webpage.it is used in seo when people search it top your website based on the data information content.
 What Is the Best Way to Add Images in a Website? Answer: The image stored in your project folder  is the best way to add image and using the <img>.
